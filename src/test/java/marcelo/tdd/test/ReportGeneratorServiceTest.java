...
public class ReportGeneratorServiceTest {
	...
	@InjectMocks private ReportGeneratorService reportGeneratorService = new ReportGeneratorService();	
...
/*		assertEquals(116, Calendar.YEAR);
		assertEquals(11, Calendar.MONTH);
		assertEquals(25, Calendar.DAY_OF_MONTH);
*/		
